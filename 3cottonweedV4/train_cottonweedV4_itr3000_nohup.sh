...
EXP_ROOT="${PROJECT_DIR}/3cottonweedV4"
WORK_DIR="${EXP_ROOT}/workdirs"
EXP_NAME="exp_spatial_cbam_saff_boundaryaux_cottonweedV4_8cls_itr3000_lr0p02_bs32"
DATA_ROOT="/root/autodl-tmp/dataset/cottonweedV4_train1k"
CLASS_NAMES="${EXP_ROOT}/class_names_8.txt"
GPU_ID="${1:-0}"
...
CFG_FILE="${EXP_ROOT}/config_exp_spatial_cbam_saff_boundaryaux_itr3000_lr0p02_bs32_cottonweedV4_8cls.txt"
