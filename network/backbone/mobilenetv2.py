...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, output_stride=8, width_mult=1.0, inverted_residual_setting=None, round_nearest=8):
        ...
        # Multi-level feature taps for segmentation backbone use:
        # low:  1/4 resolution (24 channels)
        # mid:  1/8 resolution (32 channels)
        # high: 1/16 resolution (320 channels, before final 1x1 conv to 1280)
        self.low_level_idx = 3
        self.mid_level_idx = 6
        self.high_level_idx = len(features) - 2
    ...
    def forward_features(self, x, return_multi=False):
        low_level_feat = None
        mid_level_feat = None
